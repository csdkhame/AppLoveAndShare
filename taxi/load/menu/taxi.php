 ...
 <? if(1==0){ ?>
        ...
        <? } ?>
        	 ...
        	 <li   class="treeview">
		         <a  >
               <i class="fa  fa-clock-o l-menu-li-icon"></i> <span class="textmain-left-menu">&nbsp;จัดการงาน</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
 ...
 <ul class="treeview-menu"    >
             ...
             <li ><a     id="slide_menu_add_new_shopping"><i class="fa fa-plus-circle" ></i><span  class="textsub-left-menu-slide">ไปช็อปปิ้ง</span></a></li>
           
           <li ><a id="slide_menu_all_shopping" ><i class="fa fa-circle-o" ></i><span  class="textsub-left-menu-slide">งานส่งแขกช็อปปิ้ง</span></a></li>
           
            <li style="display:none" ><a href="?name=today" ><i class="fa fa-circle-o" ></i><span  class="textsub-left-menu-slide">งานรับ-ส่ง</span></a></li>
 ...
 */
		 ...
		 <li  id="menu_user" class="treeview">
		         <a href="#" >
              <i class="fa fa-taxi l-menu-li-icon"></i> <span class="textmain-left-menu">&nbsp;ข้อมูลรถ</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
 ...
 <li ><a     id="slide_menu_add_new_car"><i class="fa fa-plus-circle" ></i><span  class="textsub-left-menu-slide">เพิ่มรถใหม่</span></a></li>
            
   <li ><a   id="slide_menu_all_car"><i class="fa fa-circle-o" ></i><span  class="textsub-left-menu-slide">รถทั้งหมด</span></a></li>
...
<? if(1==1){ ?>
		  ...
		  <i class="fa fa-recycle l-menu-li-icon"></i> <span  class="textmain-left-menu">&nbsp;บัญชีรายรับ</span>
		     <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
		   ...
		   <ul class="treeview-menu">
            <li><a id="slide_menu_account_income"><i class="fa fa-circle-o"></i><span  class="textsub-left-menu-slide">รายรับ ค่าจอด ค่าหัว</span></a></li>
			<li style="display:none"><a href="?name=booking/account&file=pay"><i class="fa fa-circle-o"></i><span  class="textsub-left-menu-slide">ประวัติการถอนเงิน</span></a></li>
		<li><a id="slide_menu_account_bank"><i class="fa fa-circle-o"></i><span  class="textsub-left-menu-slide">บัญชีธนาคาร</span></a></li>
...
$( "#load_mod_popup" ).toggle();
  ...
  var url_load = "load_page_mod.php?name=pay&file=bank";
 ...
 var url_chat_main = "load_page_chat.php?name=livechat/all&file=all_user&driverid=<?=$user_id?>&chat_from=driver&lang=th";
    ...
    $('#load_data_manage_work').html(load_main_mod);
	 $('#load_data_manage_work').load(url_chat_main); 
 	 ...
 	 <li  id="menu_chat">
          <a >
            <i class="fa fa-comments l-menu-li-icon"></i> <span class="textmain-left-menu">&nbsp;แชท
		...
		<li  id="menu_pay" lass="treeview">
		  ...
		  <i class="fa fa-desktop l-menu-li-icon"></i> <span  class="textmain-left-menu">&nbsp;โปรแกรมช่วยเหลือ</span>
		     <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
