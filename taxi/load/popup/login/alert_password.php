...
$('#chk_password_phone').click();
 ...
 <span class="glyphicon glyphicon-user form-control-feedback"></span>
  ...
  <tr>
      <td style="background-color:#FFFFFF ">  <button type="button" id="submit_password" class="btn btn-block " style="background-color:#17B3B2; color:#FFFFFF;font-size: 26px">ส่งรหัสผ่าน</button></td>
