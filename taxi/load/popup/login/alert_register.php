...
<div class="css-full-popup"  id="alert_show_register" style="display:none; position:fixed;    padding:0px; margin-top:0px; "> 
  ...
  <table width="100%" border="0" cellspacing="2" cellpadding="2" style="background-color:#1BB4B4">
  <tbody>
    <tr>
      ...
      <td><img src="images/app_logo/logo/welove.png?v=3" height="40"    align="absmiddle"></td>
    </tr>
  </tbody>
</table>
