...
$res[extra_person] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_id=".$_GET[plan_id]." and type='person' ");
 ...
 $res[extra_park] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_setting=".$_GET[plan_setting]." and type='park' and plan_type='".$_GET[type]."'  and control='".$_GET[control]."'");
 $arr[extra_park] = $db->fetch($res[extra_park]);
 
 
$res[extra_person] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_id=".$_GET[plan_setting]." and type='person' and plan_type='".$_GET[type]."' and control='".$_GET[control]."'");
 $arr[extra_person] = $db->fetch($res[extra_person]);
 
  
$res[extra_com] = $db->select_query("SELECT * FROM plan_product_price_extra WHERE  from_number <= $number AND to_number >= $number  and plan_id=".$_GET[plan_setting]." and type='commision' and plan_type='".$_GET[type]."' and control='".$_GET[control]."'");
