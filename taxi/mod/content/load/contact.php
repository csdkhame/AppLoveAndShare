...
?> 
 ...
 $('#topic_edit').html('แก้ไข <? echo $arr[contact][name];?>');
  ...
  var url_page_type_<? echo $arr[contact][id];?>= "go.php?name=content/load&file=contact&op=sub_edit&contact=<? echo $_GET[id];?>&id=<? echo $arr[contact][id];?>&main=<? echo $arr[product][main];?>&sub=<? echo $arr[product][sub];?>";
...
///
  ...
  $('#div_send_data_msg').html(response);  });  
   ...
   var url_page_type= "empty_style.php?name=content/load&file=contact&main=<? echo $arr[product][main];?>&sub=<? echo $arr[product][sub];?>&contact=<? echo $_GET[contact];?>";
    ...
    <tr>
      <td width="650" valign="top"><table width="100%" border="0" cellspacing="3" cellpadding="3">
          ...
          <td><select  class="form-control" name="admintype" id="admintype" style="width:500px;; font-size:16px; padding:5px; height:40px" >
            ...
            <option value="1" >Love&Share</option>
