...
<br>
 ...
 .input-disable { 
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="2">
      <tbody>
        <tr>
          <td width="180"> <button type="button" class="btn btn-primary btn-lg"   id="submit_data_update"  style=" width:150px"> <span id="txt_btn_save">อัพเดทราคา</span> </button>
  </td>
          <td width="400">  <div class="font-34"><b><?=$arr[place][topic_th]?></td>
          <td><strong> </strong></td>
        </tr>
      </tbody>
    </table>
...
$('.main_td_commision').<?=$status_show_commision?>();
  ...
  <table width="100%" border="0" cellspacing="1" cellpadding="1"    style="padding-top:5px;" class="div-menu-palce">
    <tr>
      ...
      <td width="920" class="font-22"><table width="<?=$tb_w?>" border="0" cellspacing="2" cellpadding="2">
        <tbody>
          <tr >
            <td width="50" bgcolor="#C7EAFB" id="main_td_park">
            ...
            <table width="50" border="0" align="center" cellpadding="3" cellspacing="3">
              <tbody>
                <tr>
                  <td width="65" align="center"><strong> บริษัท</strong>
                    <input name="price_park_driver" type="number" class="check_load_park_company" id="main_price_park_company" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_park_driver"><strong> คนขับ </strong>
                    <input name="price_park_driver" type="number"  id="main_price_park_driver" style="width:60px; " value="<? echo $arr[shop][price_park_driver];?>" />
                    
                    
                    </td>
                  <td width="65" align="center" class="check_load_park_counter" ><strong> เคาน์เตอร์ </strong>
                    <input name="price_park_counter" type="number" id="main_price_park_counter" style="width:60px; " value="<? echo $arr[shop][price_park_counter];?>" /></td>
                  <td width="65" align="center" class="check_load_park_all">
                  
                  
                  <strong>สมาชิก</strong>                    <input name="price_park_all" type="number"  id="main_price_park_all" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_all];?>" /></td>
                  </tr>
                </tbody>
              </table></td>
            <td width="50" bgcolor="#FFFDE9" id="main_td_person">
            ...
            <table width="50" border="0" align="center" cellpadding="3" cellspacing="3">
              <tbody>
                <tr>
                  <td width="65" align="center"><strong> บริษัท</strong>
                    <input name="price_park_driver" type="number"  id="main_price_person_company" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                  <td width="65" align="center"  class="check_load_person_driver"><strong> คนขับ </strong>
                    <input name="price_person_driver" type="number" id="main_price_person_driver" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_person_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_person_counter"><strong> เคาน์เตอร์ </strong>
                    <input name="price_person_counter" type="number"  id="main_price_person_counter" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_person_counter];?>" /></td>
                  <td width="65" align="center" class="check_load_person_all"><strong>สมาชิก</strong>   <input name="price_person_all" type="number"  id="main_price_person_all" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_person_all];?>" /></td>
                  </tr>
                </tbody>
              </table></td>
            <td width="50" bgcolor="#E9FBCF" id="main_td_commision">
            ...
            <table width="50" border="0" align="center" cellpadding="3" cellspacing="3">
              <tbody>
                <tr>
                  <td width="65" align="center"><strong> บริษัท</strong>
                    <input name="price_park_driver" type="number" class="sload_park_driver" id="main_price_commision_company" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_commision_driver"><strong> คนขับ </strong>
                    <input name="price_commision_driver" type="number" class="sload_commision_driver" id="main_price_commision_driver" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_commision_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_commision_counter"><strong> เคาน์เตอร์ </strong>
                    <input name="price_commision_counter" type="number" class="sload_commision_counter" id="main_price_commision_counter" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_commision_counter];?>" /></td>
                  <td width="65" align="center" class="check_load_commision_all"><strong>สมาชิก</strong>
                    <input name="price_commision_all" type="number" class="sload_commision_all" id="main_price_commision_all" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_commision_all];?>" /></td>
                  </tr>
                </tbody>
              </table></td>
            </tr>
...
<div id="main_country" style="display:nones">
...
?>
 ...
 <table width="100%" border="0" cellspacing="1" cellpadding="1"  class="box-bottom-line" style="padding-top:5px;">
    ...
    <tr>
      ...
      <td class="font-22"><table width="<?=$tb_w?>" border="0" cellspacing="2" cellpadding="2">
        <tbody>
          <tr>
            <td width="50" bgcolor="#C7EAFB" class="main_td_park"><table width="50" border="0" align="center" cellpadding="3" cellspacing="3" >
              <tbody>
                <tr>
                  <td width="65" align="center"><strong>บริษัท</strong>           <input name="price_park_company[]" type="number" class="load_park_company" id="price_park_driver" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_park_driver"><strong> คนขับ </strong>
                    <input name="price_park_driver[]" type="number" class="load_park_driver" id="price_park_driver" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                   
                  <td width="65" align="center" class="check_load_park_counter"><strong> เคาน์เตอร์ </strong>
                    <input name="price_park_counter[]" type="number" class="load_park_counter" id="price_park_counter" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_counter];?>" /></td>
                  <td width="65" align="center" class="check_load_park_all"><strong>สมาชิก</strong>                    <input name="price_park_all[]" type="number" class="load_park_all" id="price_park_all" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_all];?>" /></td>
                </tr>
              </tbody>
            </table></td>
            <td width="50" bgcolor="#FFFDE9" class="main_td_person">
            ...
            <table width="50" border="0" align="center" cellpadding="3" cellspacing="3">
              <tbody>
                <tr>
                  <td width="65" align="center"><strong>บริษัท</strong>
                    <input name="price_person_company[]" type="number" class="load_person_company" id="price_person_company" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                  <td width="31" align="center" class="check_load_person_driver"><strong> คนขับ </strong>
                    <input name="price_person_driver[]" type="number" class="load_person_driver" id="price_person_driver" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_person_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_person_counter"><strong> เคาน์เตอร์ </strong>
                    <input name="price_person_counter[]" type="number" class="load_person_counter" id="price_person_counter" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_person_counter];?>" /></td>
                  <td width="65" align="center" class="check_load_person_all"><strong>สมาชิก</strong>                    <input name="price_person_all[]" type="number" class="load_person_all" id="price_person_all" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_person_all];?>" /></td>
                </tr>
              </tbody>
            </table>
            ...
            <td width="50" bgcolor="#E9FBCF" class="main_td_commision">
            
                     <table width="50" border="0" align="center" cellpadding="3" cellspacing="3">
              <tbody>
                <tr>
                  <td width="65" align="center"><strong>บริษัท</strong>
                    <input name="price_commision_company[]" type="number" class="load_commision_company" id="price_commision_company" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_park_driver];?>" /></td>
                  <td width="31" align="center" class="check_load_commision_driver"><strong> คนขับ </strong>
                    <input name="price_commision_driver[]" type="number" class="load_commision_driver" id="price_commision_driver" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_commision_driver];?>" /></td>
                  <td width="65" align="center" class="check_load_commision_counter"><strong> เคาน์เตอร์ </strong>
                    <input name="price_commision_counter[]" type="number" class="load_commision_counter" id="price_commision_counter" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_commision_counter];?>" /></td>
                  <td width="65" align="center" class="check_load_commision_all"><strong>สมาชิก</strong>                    <input name="price_commision_all[]" type="number" class="load_commision_all" id="price_commision_all" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][price_commision_all];?>" /></td>
                </tr>
              </tbody>
            </table>
      ...
      </table><input name="id[]" type="hidden"   id="id" style="width:60px; background:#FFFFFF" value="<? echo $arr[shop][id];?>" /></td>
