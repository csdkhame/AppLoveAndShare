...
?>
 ...
 $('#topic_edit').html('เพิ่มผู้ติดต่อใหม่');
  ...
  $('#show_data_page').load(url_page_type_all);
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:22px;"  class="div-menu-palce" >
      ...
      <a style="font-size:22px; color:#000000" id="all_sub"  > <i class="fa <? echo $arr[projectmain][logo_code];?>" style="width:24px; font-size:22px; color:#666666"  ></i><? echo $arr[projectmain][topic_th];?>ทั้งหมด </a>    &nbsp; |&nbsp;  
        ...
        <a style="font-size:22px;" id="all_contact" ><? echo $arr[projectsub][topic_th];?>ทั้งหมด</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a   id="add_new_contact"style="font-size:22px;"> <i class="fa  fa-plus-circle" style="width:30px; font-size:24px;"  ></i>&nbsp;เพิ่มผู้ติดต่อใหม่</a>  
 	
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a   id="add_type_contact"style="font-size:22px;"> <i class="fa  fa-plus-circle" style="width:30px; font-size:24px;"  ></i>&nbsp;เพิ่มตำแหน่งผู้ติดต่อ</a>  
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a   id="add_type_contact_add"style="font-size:22px;"> <i class="fa  fa-plus-circle" style="width:30px; font-size:24px;"  ></i>&nbsp;เพิ่มผู้ดูแล</a>  
        </td>
      </tr>
    </table>
