...
$res[news] = $db->select_query("SELECT * FROM shopping_product_sub where main='".$arr[project][id]."'  ORDER BY  id  ASC");
$count=0;
...
$('#list_menu_add_new_booking_<? echo $arr[news][id];?>').click(function(){  
 ...
 var url_load = "load_page_mod_2.php?name=shop&file=shop&driver=<?=$user_id?>&type=<? echo $arr[news][id];?>";
...
alert("ยังไม่มีสินค้า");
                    ...
                    <?   $shop = $db->num_rows('shopping_product',"id","sub=".$arr[news][id]."  and status=1");?>
 ...
 <font color="<?=$main_color_dark?>" class="font-26"> 
      ...
      <? } ?>       
              ...
              <? } ?>       
			        ...
			        <td width="60" align="center" class="font-26" style="padding-top:0px; padding-right:10px;">(<?=$shop?>)</td>
			        <td width="40" align="center" class="font-26" style="padding-top:0px; padding-right:5px;"><i class="fa fa-search" style=" color:#666666"></i></td>
                  </tr>
			      </table>
