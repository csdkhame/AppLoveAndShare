 ...
 <? } ?>
   ...
   <table width="100%" border="0" cellspacing="2" cellpadding="2">
    ...
    <tr>
      ...
      <td id="status_open_<? echo $arr[project][id];?>2" class="font-26">เปิดให้บริการ</td>
    </tr>
    <tr>
<td class="font-22"><strong>ค่าตอบแทน</strong></td>
      <td><span id="shop_alert_menu_price_<?=$arr[project][id]?>" class="font-22"> <i class="fa fa-calculator" style="font-size:16px; color:<?=$main_color?>; width:20px;"></i>  ดูค่าตอบแทน</b></span></td>
    </tr>
    <tr>
<td class="font-22"><strong>ตำแหน่งที่ตั้ง</strong></td>
      <td><span id="shop_alert_menu_map_<?=$arr[project][id]?>" class="font-22"> <i class="fa fa-map-marker" style="font-size:20px; color:<?=$main_color?>; width:20px;"></i>แผนที่</b></span></td>
    </tr>
    <tr>
...
<span id="shop_alert_menu_call_<?=$arr[project][id]?>" class="font-22"> <i class="fa fa-phone-square" style="font-size:18px; color:<?=$main_color?>; width:20px;"></i>การตลาด (<?=$arr[sale][name]?>)</b></span></a>
...
<? } ?>
    ...
    <tr>
      ...
      <td>
        ...
        <a    style="color:#333333; text-decoration:none"   id="shop_alert_menu_index_load_<?=$arr[project][id]?>" class="font-22"> <i class="fa fa-download" style="font-size:18px; color:<?=$main_color?>; width:20px;"></i> โบร์ชัวร์</span></a>   
     </td>
    </tr>
