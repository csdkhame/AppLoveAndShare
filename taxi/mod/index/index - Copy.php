...
<script>
 ...
 var url_car_start = "go.php?name=checkcar/load&file=start&type=usecar&drivername=<?=$user_id;?>&usecar=start";   
...
<div class="box-body" style="padding:0px; padding-top:10px; display:none">
     <table width="100%"  border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td width="33%"> <a class="btn btn-app " style="background-color:#FFFFFF; width:auto"  >
                <span class="badge bg-yellow"><font class="font-20"><?=$allwork?></font></span>
                <i class="fa fa-clock-o "></i> <font class="font-20">งานวันนี้
              </a></td>
    <td width="33%">              <a class="btn btn-app" style="background-color:#FFFFFF ">
                <span class="badge bg-teal"><font class="font-20"><?= $profileall?>%</font></span>
                <i class="fa fa-user"></i> <font class="font-20">โปรไฟล์
              </a></td>
    <td width="33%">              <a class="btn btn-app" style="background-color:#FFFFFF ">
                <span class="badge bg-red"><font class="font-20">0</font></span>
                <i class="fa fa-bell"></i> <font class="font-20">แจ้งเตือน
              </a></td>
  </tr>
</table>
...
<table width="100%"  border="0" cellspacing="2" cellpadding="2"  style="display:none">
  <tr>
    <td width="40%" valign="top" ><img src="http://t-booking.com/admin/file/driver/pic/<?=$arr[web_user][post_date];?>.jpg"  width="100%"   border="0"  class="IMGSHOP"   style="margin-top:15px;border-radius:5px;" /></td>
...
?>
      ...
      <tr>
        <td width="80"  class="font-20"><strong>หมายเลข</strong></td>
        <td  class="font-20"><? echo "" . $arr[other][car_num] . ""; ?></td>
      </tr>
      <tr>
        <td  class="font-20"><strong>ประเภท</strong></td>
        <td  class="font-20"><? echo "" . $arr[aum][topic_en] . " "; ?></td>
      </tr>
      <tr>
        <td class="font-20"><strong>ยี่ห้อ</strong></td>
        <td class="font-20"><?echo $arr[other][car_brand];?></td>
      </tr>
      <tr>
        <td class="font-20"><strong>รุ่น</strong></td>
        <td class="font-20"><?echo $arr[other][car_sub_brand];?></td>
      </tr>
    </table></td>
  </tr>
</table>
...
p {
 ...
 <button type="button"  id="button2" class="btn btn-secondary" data-container="body" data-toggle="popover" data-placement="bottom" data-content="Vivamus
sagittis lacus vel augue laoreet rutrum faucibus." style="display:none">
  Popover on bottom
</button>
