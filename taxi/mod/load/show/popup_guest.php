          ...
          <tr>
            <td class="gay5"><div class="topictransfer">ถ่ายสถานที่รับแขก (ถ้ามี)</div>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_topoint_<?=$arr[project][id];?>_1">
          &nbsp;
...
$('#url_photo_topoint_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
                ...
                <div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_topoint_<?=$arr[project][id];?>_2">
          &nbsp;
 ...
 /// check login
  ...
  $(function () {
   ...
   <div class="input-group">
     ...
     <input name="text" type="text" class="form-control" id="url_photo_checkguest_<?=$arr[project][id];?>_1"  style="padding-left:5px; padding-right:5px; width:100px" value="ยังไม่มีภาพถ่าย" readonly />
     &nbsp;
...
$('#url_photo_checkguest_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
   ...
   <div class="input-group" style="margin-top:10px; ">
     ...
     <input name="text" type="text" class="form-control" id="url_photo_checkguest_<?=$arr[project][id];?>_2"  style="padding-left:5px; padding-right:5px; width:100px" value="ยังไม่มีภาพถ่าย" readonly />
     &nbsp;
...
$('#driver_remark_noguest_<?=$arr[project][id];?>').addClass("tab_alert");
	...
	<tr>
		<td><div class="topictransfer">รูปภาพประกอบ (ถ้ามี)</div> 
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_noguest_<?=$arr[project][id];?>_1">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_1"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_noguest_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_noguest_<?=$arr[project][id];?>_2">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_2"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_noguest_<?=$arr[project][id];?>_2').css({"background": "#fa1431","color": "#333333", });
			...
			<div class="input-group" style="margin-top:10px; ">
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_noguest_<?=$arr[project][id];?>_3">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_3"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
...
$('#url_photo_noguest_<?=$arr[project][id];?>_3').css({"background": "#fa1431","color": "#333333", });
			...
			<div class="input-group" style="margin-top:10px; ">
                ...
                <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_noguest_<?=$arr[project][id];?>_4">&nbsp;<button type="button" class="btn btn-default" data-toggle="modal"   style="padding-left:5px; padding-right:5px; width:30px" id="del_photo_noguest_<?=$arr[project][id];?>_4"><i class="fa  fa-trash" style="font-size:20px; "></i></button>
          ...
          <tr>
            <td class="gay5"><div class="topictransfer">ถ่ายสถานที่ส่งแขก (ถ้ามี)</div>
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_finishpoint_<?=$arr[project][id];?>_1">
&nbsp;
...
$('#url_photo_finishpoint_<?=$arr[project][id];?>_1').css({"background": "#fa1431","color": "#333333", });
                ...
                <div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_finishpoint_<?=$arr[project][id];?>_2">
&nbsp;
...
$('#url_photo_finishpoint_<?=$arr[project][id];?>_2').css({"background": "#fa1431","color": "#333333", });
                ...
                <div class="input-group" style="margin-top:10px; ">
                  ...
                  <input type="text" class="form-control" value="ยังไม่มีภาพถ่าย" readonly  style="padding-left:5px; padding-right:5px; width:100px" id="url_photo_finishpoint_<?=$arr[project][id];?>_3">
&nbsp;
...
border-radius: 5px;padding:5px; font-size:20px; width:100%; background-color:<?=$ok_button_color?>;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF
...
border-radius: 5px;padding:5px; font-size:20px;  width:100%; background-color:<?=$no_button_color?>;font-family:Arial, Helvetica, sans-serif ; color:#FFFFFF
}
